...
class ColorConstants {
  ...
  static const Color inputBackgroundColor = Color(0xFFD4D4D4);
  static const Color inputPlaceholderColor = Color(0xFFA6A6A6);
  ...
  /// 主色
  static const Color primary = Color(0xFF007EF2);

  /// 文本主色
  static const Color primaryText = Color(0xFF292F51);

  /// 辅色
  static const Color secondary = Color(0xFF6791FF);
